...
Jak łatwo się domyśleć, takie wywoływanie trwałoby w nieskończoność.
...
Stwórz funkcję `divergence(zR, zC, cR, cC)`, która wyznacza elementy ciągu $z_{n+1} = z_n^2 + c$, gdzie $z_0 = zR + zC \cdot i$, zaś $c = cR + cC \cdot i$.
