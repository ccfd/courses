...
Funkcje można zagnieżdżać, np. wywołanie `VLOOKUP(CONCATENATE(...), CONCATENATE(...))` jest prawidłowe.  
...
Ściągnij przykładowy plik [wyniki.dat](data/info1/dane.dat) i przenieś go do katalogu z plikiem arkusza kalkulacyjnego.
