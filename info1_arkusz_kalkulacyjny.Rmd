...
Podpowiedzi do ćwiczeń zostały oparte o program *LibreOffice Calc*.
...
- Kolumnę `Imię i Nazwisko` należy wypełnić korzystając z funkcji `CONCATENATE()` i `VLOOKUP()`. Funkcje można zagnieżdzać, np. wywoałanie `VLOOKUP(CONCATENATE(...); CONCATENATE(...))` jest prawidłowe.  
