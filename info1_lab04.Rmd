...
Aby określić kres dolny oraz długość takiego przedziału musimy dokonać kilku transformacji na wylosowanych liczbach:
Jedną z metod jest wzięcie wyłącznie reszty z dzielenia przez zadaną długość przedziału i dodanie kresu dolnego.
Przykładowo:
```c++
...
- Wybierz krótki przedział (rzędu kilku możliwych do wylosowania liczb) i wykonaj 1000 oraz 10000 losowań.
W obu przypadkach zliczaj, ile razy wylosowano każdą z liczb.
...
Ponieważ wylosowane punkty znajdują się w obszarze kwadratu o wymiarach $[0, 1] \times [0, 1]$, najwygodniej będzie przeskalować współrzędne 200-krotnie.
...
Dzięki temu, zliczając wylosowane punkty, które trafiły do wnętrza koła, możemy określić przybliżenie liczby $\pi$.
...
- Wydrukuj na ekranie zależność względnego błędu przybliżenia $\pi$ od potęgi liczby 2 w zakresie  $2^{8}$ do $2^{32}$.
