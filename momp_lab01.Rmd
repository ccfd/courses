---
title: Wprowadzenie do środowiska ANSYS Workbench 2020 R2
number: 0
...
W ramach poznawania modułu CAD wykonajmy geometrię na potrzeby [Instrukcji II - poprawić link!!!!](https://ansyshelp.ansys.com/).
...
![**Rys. 6.** Rozwinięte menu kontekstowe](figures/momp_inst1/DMmenu.svg#center)
	...
	d. Po każdej nowo wstawionej operacji w trybie modelingu powinniśmy ją stworzyć przy pomocy guzika **Generate**
...
5. Aby teraz przejść do trybu szkicownika, **zaznacz** nowo utworzony szkic w oknie drzewa historii i w tym samym oknie wejdź w zakładkę **Sketching**. Pojawi się nowe okno z zakładkami. Każda zakładka ma **dwie czarne strzałki** do nawigowania - Rys. 8a. Mamy do dyspozycji zakładkę **Draw**, w której znajdziemy wszystkie potrzebne "kreski". Zakładkę **Dimensions**, w której znajdziemy wszystkie narzędzia do wymiarowania (przydatna tutaj jest opcja **move** do przesuwania wymiaru).
...
7. Zaznaczamy kolejno elementy domeny (krawędzie) i nazywamy je tak jak zostały nazwane w rysunku poglądowym w akapicie ["Moduł geometryczny..."](#moduł-geometryczny---designmodeler). Dla obu powierzchni tworzymy jedną nazwę **air**.
