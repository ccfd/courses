...
![**Rys.1.** *Szkic 1 na płaszczyźnie X-Y*](instr4_geom.svg "Szkic 1")
...
![**Rys.2.** *Szkic 2 na płaszczyźnie Y-Z*](instr4_geom2.svg "Szkic 2")
...
11. Obecnie skrzydło delta jest na 0 kącie natarcia. Nalezy zmienić kąt natarcia naszego skrzydła o 30 stopni
	...
	![**Rys.3.** *Obrót*](instr4_rotate.svg "Obrót")
	...
	**Wybieramy geometrie** do obrotu. To można zrobić na dwa sposoby (patrz rysunek).
	...
	![**Rys.4.** *Sposoby zaznaczania*](instr4_rotateopt.svg "Select")
	...
	![**Rys.5.** *Sposoby wskazania osi obrotu*](instr4_rotateopt2.svg "Oś obrotu")
...
![**Rys.6.** *Nazwy warunków brzegowych*](instr4_namedselect.svg "Domena")
...
![**Rys.7.** *Jedna z wizualizacji przepływu*](instr4_wiz.svg "Wizualizacja")
...
![**Rys.8.** *Opcje zapisu*](instr4_accept.svg "Wizualizacja")
