...
![**Rys.3.** *Sposoby dodawania nowych elementów do schematu projektu*](addblocks.svg "ANSYS Workbench 2020 R2")


W ten sposób możemy tworzyć duże schematy projektów (Rys. 4).


![**Rys.4.** *Przykład rozwiniętego schematu projektu*](Schematic_sample.PNG "ANSYS Workbench 2020 R2")
...
![](cellState.PNG "ANSYS Workbench 2020 R2")

**Poszczególne komórki programów mogą mieć różne stany w zależności od aktywności użytkownika:**

![](wb2_unfulfilled.jpg "Unfulfilled") - *Brak danych* - Wymagane są dane z poprzedzających komórek. W tym stanie komórki mogą się nie otworzyć.

![](wb2_refreshrequired.jpg "Refresh required") - *Odśwież dane* - Dane w komórkach poprzedzających zostały zmienione od ostatniego stanu.

![](wb2_attentionrequired.jpg "Attention required") - *Program wymaga uwagi* - Program w tym stanie nie zwróci żadnych danych do kolejnych komórek, dopóki nie uzupełni się braków.

![](wb2_updaterequired.jpg "Update required") - *Zaktualizuj dane* - Wewnętrzne dane zostały zmienione, jednak program nie przekazał wyniku do środowiska Workbench. Należy odświeżyć daną komórkę, aby zsynchronizować dane.

![](wb2_uptodate.jpg "Up to date") - *Aktualne dane* - dane są aktualne i nie znaleziono błędów.

![](wb2_inputchgpending.jpg "Input pending") - *Zmienione dane* - Komorka jest aktualna ale może się zmienić w związku z wykrytą zmianą wcześniejszych komórek.


**Stany typowe dla programów obliczeniowych:**

![](wb2_interrupted_update_required.png "Interrupted update") - *Przerwano, zaktualizuj dane* - Przerwano podczas obliczeń. Wygenerowane dane do momentu przerwania są dostępne jednak plik z wynikami jest pusty.

![](wb2_interrupted.png "Interrupted up to date") - *Przerwano, aktualny* - Przerwano podczas obliczeń. Plik z wynikiem zawiera dane. Ten stan występuje, jeżeli przerwano kilka obliczeń pod rząd.

![](wb2_pending.jpg "Pending") - *Oczekuje* - W trakcie analizy w trybie batch. Można wykonywać operacje w innych systemach w projekcie. 


**Stany błędów:**

![](wb2_refreshFailed.png "Refresh failed") - *Nie udało się odświeżyć, Odśwież dane*

![](wb2_updFailedUpdReqd.png "Update failed") - *Nie udało się zaktualizować, Zaktualizuj dane*

![](wb2_updFailedAttReqd.png "Update failed") - *Nie udało się zaktualizować, Program wymaga uwagi*
...
<p>
![**Rys. 6.** Rozwinięte menu kontekstowe](DMmenu.svg)
</p>
</details>
...
<p>
![**Rys. 7.** Menu szkicownika](sketchMenu.svg)
</p>
</details>
...
<p>
![**Rys. 8.** Stwórz powierzchnię ze szkicu](newsurface.svg)
</p>
</details>
...
<p>
![**Rys. 9.** Stwórz złożenie](formnewpart.svg)
</p>
</details>
