...
Użycie funkcji `animate` wygląda następująco:
```c++
for(i = 0; i < 50; i++) {
  animate(100);   // jako argument funkcji wpisujemy ilość klatek na sekundę (oczekiwanie przez 10 ms)
