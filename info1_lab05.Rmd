...
Poniższy program ma błąd. Tego typu luka (stack buffer overflow) była wielokrotnie wykorzystywana przez twórców złośliwego oprogramowania^[S(https://en.wikipedia.org/wiki/Stack_buffer_overflow)]. 
Sprawdź jak różni się wynik uruchomienia programu wersji 'release/debug' oraz 'x84/x64'.  [Zaalokuj](info1_lab07.html)
