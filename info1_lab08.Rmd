...
- Zamknij powyższe operacje w funkcji o nagłówku ```cvoid MatVecMultiply(double **A, double *v1, double *v2, int n)``` i dokonaj wywołania z funkcji `main`.
...
- Napisz funkcję ```cMatMatMultiply(double **A, double **B, double **C, int mA,
