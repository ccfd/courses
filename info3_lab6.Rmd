...
nms = c("alokacja","losowanie",expression(S[1]),expression(S[2]))
cls = 1:4
Y = max(apply(tms,2,sum))

plot (NA, ylab="Time", xlab="", xlim=c(0,3),ylim=c(Y,0), xaxt='n', yaxt='n')
...
plot (NA, ylab="", xlab="", xlim=c(0,3),ylim=c(Y,0), xaxt='n', yaxt='n')
axis(1,at=0:3,paste("rank",0:3,sep="="))
for (i in 1:ncol(tms)) {
