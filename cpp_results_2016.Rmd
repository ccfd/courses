...
```{r kable, echo=FALSE}
tab=read.csv(url)
nTab = data.frame(Numer.albumu=tab$Numer.albumu, Etap.studiów=tab$etap.studiów, Semestr=tab$Semestr, Test=tab$TEST, Projekt=tab$PROJEKT, Lab.Suma=tab$LSuma, Suma=tab$SUMA.LAB, Ocena=tab$OCENA)
kable(nTab)
```
