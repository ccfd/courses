...
1.	W celu dokładnego rozwiązania równań w miejscach dużych skoków wartości zmiennych włącz automatyczne zagęszczanie siatki (Górna belka programu **Domain / Adapt / Refine/Coarsen...**) z opcjami:
	...
	1.	Stworz warunek dla rozrzedzenia **Cell registers / New / Field Variable...**
		...
		- w **Scaling Option** wybierz **Scale by Zone Maximum** (gradient będzie porównywany z lokalną średnią prędkością.)
		- **Save**
	...
	3.	Zaznacz **Dynamic Adaption**, wpisz **Interwał** 100 iteracji (adaptacja siatki nastąpi raz co 100 kroków);
	
	4. W polu **Refinement Criterion** wybierz Twój warunek **Refine**
	
	5. W polu **Coarsening Criterion** wybierz Twój warunek **Coarsen**
	
	6. W polu **Maximum Refinement Level** wpisujemy **2**.
