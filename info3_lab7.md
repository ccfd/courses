...
## Simple Mail Transfer Protocol (SMTP) Port:25 SSL:587
...
## Post Office Protocol version 3 (POP3) Port:110 SSL:995
...
## Hypertext Transfer Protocol (HTTP) Port:80 SSL:443
...
- Uruchom putty. Wejdz w ustawienia ,,tunneling". Tam ustaw by port {\tt 80} był przekierowany na {\tt google.com:80}. Następnie połącz się z maszyną {\tt info3} jak zwykle.
...
- Uruchom putty. Wejdz w ustawienia "tunneling". Tam ustaw by port {\tt 66666} był przekierowaniem typu "Dynamic". Następnie połącz się z maszyną {\tt info3} jak zwykle.
