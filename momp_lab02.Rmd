...
11.	Wczytujemy zadany profil prędkości do Fluenta za pomocą okna *(Górna belka)* User-Defined/Functions/Interpreted potwierdzić przyciskiem Interpret.
	...
	![**Rys. 1.** Sposób wczytywania interpretowanej funkcji UDF](figures/momp_inst2/interpreted.svg#center)
...
![Dane potrzebne do pliki UDF](figures/momp_inst2/udfvariables.svg#center)
...
![Dane potrzebne do pliki UDF](figures/momp_inst2/addlines.svg#center)
...
![Dane potrzebne do pliki UDF](figures/momp_inst2/reattachment.svg#center)
